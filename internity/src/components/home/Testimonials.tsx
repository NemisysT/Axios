...
const testimonials = [
  ...
  },
  {
    ...
    quote: "I was able to apply to 20 jobs in under 2 minutes, so that's going great for me!",
  },
  {
    name: "Soumya",
    role: "Data Analyst",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-xl p-6 transition-all duration-300 hover:border-purple-600 hover:-translate-y-1"
            >
